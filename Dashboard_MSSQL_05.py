...
def view_all_data():
    get_statement = """
    select * from dbo.Python_Insurance WITH(NOLOCK) order by id
    """
    # print("GetData")
    try:
...
st.set_page_config(page_title="Dashboard_04",page_icon="🌍",layout="wide")
...
# # load Style css
# with open('D:\Data\CSS\\style.css')as f:
#     st.markdown(f"<style>{f.read()}</style>", unsafe_allow_html = True)

#uncomment these two lines if you fetch data from mssql
...
# df=pd.read_excel('D:\Data\Excel\\InsuranceData.xlsx', sheet_name='Sheet1')

#side bar logo
# st.sidebar.image("D:/Data/Image/adidas-logo.jpg",caption="Online Analytics")
st.sidebar.image("kpi.jpg", caption="Online Analytics")
...
def Home():
    with st.expander("VIEW MSSQL DATASET"):
...
sideBar()
st.sidebar.image("D:\Data\Image\company_logo.png",caption="")
