...
owmKey='9d39ef883b9396c0f3c495cf3ca66aa0'
...
def dynamiclabels():
    ...
    try:
        weatherImg=customtkinter.CTkImage(Image.open(f"D:/Data/Python/python_weather_ctkinter_gui-main/weatherImages/{weatherData['status']}.png"),size=(120,120))
    except Exception as e:
        weatherImg=customtkinter.CTkImage(Image.open(f"D:/Data/Python/python_weather_ctkinter_gui-main/weatherImages//default.png"),size=(120,120))
...
placesCombo=customtkinter.CTkComboBox(frame,values=["Seoul,KR","Busan,KR","Ulsan,KR","Daegu,KR","Iloilo, PH","Manila, PH","Cebu, PH","Bacolod, PH"])
